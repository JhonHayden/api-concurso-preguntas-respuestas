...
const conectarBD = async () => {
  // funcion que me retorna la conexion a la base de datos .. el metodo
  // connect recibe como argumento el String de conexion a la base de datos

  return await mongoose
    .connect(process.env.DATABASE_URL)
    .then(() => {
      // despues de conectarse a la base de datos ejecuta el entonces .then si se conecto bien si no ejecuta
      // el .catch
